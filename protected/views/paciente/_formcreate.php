...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<table style="width:100%">
		...
		<h2>Datos Personales</h2>
			...
			<div class="row">
				<?php echo $form->labelEx($model,'Nombre y Apellidos: '); ?>
		...
		<!-- 	<div class="row">
			...
			<div class="row">
				<?php echo $form->labelEx($empresa,'Nombre Empresa'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'Tiempo de Servicio a la Empresa'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'Seccion En La Que Trabaja Actualmente:'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'Expuesto A Ruido'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'Tiempo De Servicio En La Seccion'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'Tiempo Diario De Trabajo'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'Elementos De Proteccion Auditiva'); ?>
			...
			<div> <?php  echo 'En caso afirmativo, indicar el tipo de protector auditivo' ?> </div>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'He Tenido Puestos De Trabajo Anteriores Con Ruido'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionActual,'¿Cual?'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionRuidoExtra,'Caza'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionRuidoExtra,'Reproductor De Audio Personal'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionRuidoExtra,'Armas De Fuego'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionRuidoExtra,'Otros'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionRuidoExtra,'Frecuencia'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($exposicionLaboral,'Solventes Organicos'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'Tratamiento Farmacologico'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'Tratamiento Con Antituberculosos'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'Tratamiento Aminoglucosidos(estreptomicina,kanamicina,neomicina u otro)'); ?>
		...
		<td>
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'Enfermedades Diagnosticadas por ORL'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'No cigarrillos/dia'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'Enfermedades generales padecidas con posible afeccion otica'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentes,'Intervencion Quirurgica,¿Cual?'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesMorbidos,'Hipertension arterial'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesMorbidos,'Hipercolesterolemia'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesMorbidos,'Diabetes mellitus'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesMorbidos,'Enfermedad renal'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesMorbidos,'Traumatismo acustico agudo'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesOtologicos,'Aculenos o tinilus'); ?>
			...
			<div class="row">
				...
				<?php echo $form->labelEx($antecedentesOtologicos,'Tipo De Ruido'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesOtologicos,'Afecta con cambios de posicion de cabeza'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesOtologicos,'hora de aparicion'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesOtologicos,'cual oido'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antecedentesOtologicos,'Otros,Detallar'); ?>
			...
			<div class="row">
<!-- 				<php echo $form->labelEx($antecedentesOtologicos,'Otros sintomas otologicos'); ?>
 ...
 -->
			...
			<div class="row">
				<?php echo $form->labelEx($antAudioAnter,'Lugar donde se efectuo el examen'); ?>
			...
			<div class="row">
				<?php echo $form->labelEx($antAudioAnter,'Otros examenes audiologicos complementarios si corresponde'); ?>
